...
import { Badge, Button, Card, Input, Spin, Table, Tag } from 'antd';
...
function Gastight() {
        ...
        },
        {
            ...
            render: (text: string, record: any, index: number) => {
                ...
                return <div key={index} className={` font-semibold flex flex-row items-center gap-3`}>
                    <span>{text}</span><Tag className={`${isFirstRow != 0 && 'hidden'} drop-shadow-md`} color="#ffa500" style={{ color: 'black' }}>
                        ผลิตล่าสุด
                    </Tag></div>
            }
        },
    ...
    return (
        <Spin spinning = {load} tip = 'กำลังโหลดข้อมูล'>
            <div>
                <Card className='mb-6 shadow-sm' title="Search" bordered={true}  size='small' type="inner" >
                    <div className='flex  items-center gap-3'>
                        <div className='w-fit flex items-center gap-2'>
                            <div className='text-end w-fit flex-none'>วันที่ : </div>
                ...
                <div className='grid sm:grid-cols-4 border '>
                    ...
                    <div className="col-span-2 bg-[#ffa500] text-black drop-shadow-lg">
                    ...
                    <div className="flex col-span-1 bg-[#1777fe] text-black">
